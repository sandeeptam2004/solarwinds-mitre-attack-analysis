...
7. [Detection & Mitigation Recommendations](#detection--mitigation-recommendations)
8. [Key Takeaways](#key-takeaways)
9. [Project Structure](#project-structure)
10. [5-Line Summary](#5-line-summary)
11. [Sources](#sources)
...
level detection and mitigation guidance, underscoring why supply-chain
and identity-based attacks require behavioral defenses rather than
